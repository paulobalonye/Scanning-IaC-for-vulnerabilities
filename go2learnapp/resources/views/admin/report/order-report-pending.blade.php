                                            ...
                                            @if (@$order->payment_method)
                                                ...
                                                @if(@$order->payment_method == 'bank')
                                                    ...
                                                    <p class="font-bold mb-0"><span class="fw-bold">{{ __('Deposit Slip') }}</span>:
                                                        <a class="color-blue" href="{{ asset($order->deposit_slip) }}" download>{{ __('Download') }}</a>
                                                    </p>
                                                @endif
                                            @endif
                                        ...
                                        <td>
                                            <div class="action__buttons">
                                                <a href="#"
                                                   ...
                                                   class=" btn-success p-2 btn-action mr-1 paid-order" data-toggle="tooltip"
                                                   title="Paid">{{ __('Paid') }}
                                                </a>
                                                <a href="#"
                                                   data-url="{{ route('report.order-paid', [$order->uuid, 'cancelled']) }}"
                                                   class=" btn-danger p-2 btn-action mr-1 cancelled-order" data-toggle="tooltip"
